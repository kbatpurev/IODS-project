...
#The difference between the two datasets seem to be the 3rd and 4th column. 
#The correct formar is col_double() and col_datetime rather than col_character for both.
```
...
my_datetime - current_datetime #Viola is works because of ymd_hm in front of the date - to specify that it is a date rather than just bunch of numbers
...
#This is a slightly confusing graph...Not sure how to interpret this
